...
This configuration demonstrates Docker-optimized Django settings
with environment-based configuration for containerized deployments.
"""
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': config('DB_PASSWORD', default='blogpass'),
